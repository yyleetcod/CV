...
我们讨论了这样一个事实，即较大的网络总是比较小的网络更好地工作，但是它们的更高的模型容量必须通过更强的正规化（例如更高的权重衰减）来适当地解决，或者它们可能过度拟合。我们将在后面的章节中看到更多形式的正规化（尤其是辍学）。

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc3MjgwNDQxMiw3NzI3MDU2NzgsLTExOT
Y5MjA1MzEsOTgzMzkwNjY4LC0xODczMzIwNjksOTI3MDY2OTgs
LTExMjkwNjU0MDgsLTI1NTg4ODgyOSw3NzM1OTUyNDEsOTk0MD
